...
import { ImageDocumentPage } from '../image-document/image-document';
...
export class CropDocumentPage {
	...
	crop() {
		...
		let canvas = document.getElementById('canvasOutput') as HTMLCanvasElement;
	...
	saveImage(){
		this.navCtrl.push(ImageDocumentPage,{picture:this.picture});
	}
}
