...
export class ImagePage {
    ...
    initialize() {
        ...
        cv.imshow('canvasOutputPick', src);
    }
    ...
    saveImage(){
        this.platform.ready().then(() => {
            let canvas = document.getElementById('canvasOutputPick') as HTMLCanvasElement;
    ...
    rotateRight() {
        ...
        cv.imshow('canvasOutputPick', src);
        let canvasOutput = document.getElementById('canvasOutputPick') as HTMLCanvasElement;
        let picture = document.getElementById("imgPick") as HTMLImageElement;       
    ...
    rotateLeft() {
        ...
        cv.warpAffine(src, src, M, dsize, cv.INTER_LINEAR, cv.BORDER_CONSTANT, new cv.Scalar());
        cv.imshow('canvasOutputPick', src);
        var canvasOutput = document.getElementById('canvasOutputPick') as HTMLCanvasElement;
        let picture = document.getElementById("imgPick") as HTMLImageElement;
        picture.src = canvasOutput.toDataURL();
        src.delete(); M.delete();
    } 
